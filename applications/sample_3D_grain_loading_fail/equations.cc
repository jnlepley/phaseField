...
void variableAttributeLoader::loadVariableAttributes(){
    ...
    for (unsigned int var_index=0; var_index<11; var_index++){
    ...
    //for (unsigned int var_index=0; var_index<12; var_index++){
        ...
        // For the input file 'parameters.in'
        set_dependencies_value_term_RHS(var_index, "n0, n1, n2, n3, n4, n5, n6, n7, n8, n9, n10");
        set_dependencies_gradient_term_RHS(var_index, "grad(n0), grad(n1), grad(n2), grad(n3), grad(n4), grad(n5), grad(n6), grad(n7), grad(n8), grad(n9), grad(n10)");
